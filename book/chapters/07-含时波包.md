...
本章使用 $\hbar=1$、Hartree、Bohr 和 $m_H=1836.15$。我们将从一个高斯波包出发，逐行读懂 `wavepacket.py` 的一维实现，再进入已经定量验证的 `wavepacket_2d.py`。第 6 章的定态 $T(E)$ 仍会回来：波包给的是能量加权的透射，而不是中心能量点值。所需算符语言可回查“01 数学预备”“02 量子力学基础”，输入势面见“03 势能面”“05 神经网络势能面”，反应坐标见“08 二维反应动力学”，验证、软件与拓展分别见“09 数值验证”“10 软件架构与发布”“11 进阶专题”，单位约定汇总于“附录”。
